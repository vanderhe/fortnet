...
# Expecting five geometry steps of communication with Fortnet,
# sending the same structure each time
NR_STEPS = 5
...
def main():
    ...
    specienames, species, coords, origin, latvecs = readgen("H2O_cluster.gen")
